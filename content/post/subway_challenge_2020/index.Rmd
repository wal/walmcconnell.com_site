...
To keep me motivated and on track I pulled my running data down regularly from the [Strava API](http://developers.strava.com/) and monitored progress along the way using the charts below which 
