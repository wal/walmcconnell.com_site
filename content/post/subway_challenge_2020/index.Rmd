...
I'm tracking my progress by pulling my running data down from the strava API and monitoring it below
...
blog_theme <- theme_minimal() +
  theme(legend.position='bottom'
        ,plot.title = element_text(color = "grey25", size = 24, face = "bold")) +
...
day_chart <- calendar_data %>%
  ...
  geom_text(data = calendar_data %>% filter(distance > 0), aes(label = paste0(distance, 'km')), size=3) +
